...
<html lang="en">
    <head>
        ...
        <title>Driverless - Vehicle Display</title>
    ...
    <body data-spy="scroll" data-target=".fixed-top">
        ...
        <div style="padding-top: 110px; background-color: #153e52;">
            <form action="vehicledisplay.php" method="POST">
                <table class="searchbar" align="center" width="100%">
                    <tr>
                        <td align="right" width="50%">
                            <input type="text" name="txtsearch" placeholder="Search Car Name" style="width: 150px;">
                        </td>
                        <td align="center" width="7%">
                            <input type="submit" name="btnsearch" value="Search" style="background-color: #14bf98; border-radius: 0.25rem; color:white; border: 0.125rem solid #14bf98; width:fit-content;">
                        </td>
                        <td align="left">
                            <input type="submit" name="btnshowall" value="Show All" style="background-color: #14bf98; border-radius: 0.25rem; color:white; border: 0.125rem solid #14bf98; width:fit-content;">
                        </td>
                        </tr>
                </table>
            </form>
    ...
    if ($count>0) 
    {
        ...
        { 
            ...
            { 
                ...
                echo "<td>";
                echo "<a href='cardetail.php?PID=".$arr['VehicleID']."'>";
                echo "<img src='".$arr['VehicleImage']."' width='320px''>";
                echo "<br>";
                echo "<br>";
